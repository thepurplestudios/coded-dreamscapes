...
export default function CoffeeCup() {
  ...
  "
        ...
        <ellipse cx="120" cy="70" rx="62" ry="9" fill="#6F3512" />
  ...
  "
        ...
        {/* Tiny Coffee Bubbles */}
        <circle cx="95" cy="180" r="3" fill="rgba(255,255,255,.3)" />
